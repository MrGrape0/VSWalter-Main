...
class DialogueBoxPsych extends FlxSpriteGroup
{
	...
	public function new(dialogueList:DialogueFile, ?song:String = null)
	{
		...
		skipText2 = new FlxText(142, 680, Std.int(FlxG.width * 0.6), "Press BACKSPACE to Skip!", 19);
		skipText2.font = 'Pixel Arial 11 Bold';
		skipText2.color = 0xFFFFFFFF;
		add(skipText2);

		skipText = new FlxText(140, 682, Std.int(FlxG.width * 0.6), "Press BACKSPACE to Skip!", 19);
