...
class Achievements {
	public static var achievementsStuff:Array<Dynamic> = [ //Name, Description, Achievement save tag, Hidden achievement
		...
		["No Monsters!", "Beat \"Chill-ties\" on Hard with no Misses.", 'walter_nomiss', false],
		["Thanks!", "Thank you for playing Vs Walter!", "walter_end", false],
		["Dead", "Beat Monochrome with no Misses.", 'dead', false],
		["Sus", "Get the 1% chance easter egg on MainMenu.", 'sus', false],
	];
